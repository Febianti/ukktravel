...
<head>
	<title>Travelrio a Travel Category Bootstrap Responsive Website Template | Home :: FE</title>
	<!-- Meta Tags -->
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	<meta name="keywords" content="Travelrio Responsive web template, Bootstrap Web Templates, Flat Web Templates, Android Compatible web template, 
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, Sony Ericsson, Motorola web design" />
	...
	<link href="assets/template/css/easy-responsive-tabs.css" rel='stylesheet' type='text/css' />
	...
	<link rel="stylesheet" href="assets/template/css/jquery-ui.css" /><!-- // calendar -->
	<!-- // Style-sheets -->
	<!-- Online-fonts -->
	<link href="assets/template///fonts.googleapis.com/css?family=Montserrat:100,200,400,500,600" rel="stylesheet">
	<link href="assets/template///fonts.googleapis.com/css?family=Lato:300,400,700,900" rel="stylesheet">
	<!--// Online-fonts -->
...
<body>
				...
				<div class="header-nav">
					<nav class="navbar navbar-default">
						...
						<div class="navbar-header">
							...
							<h1><a class="navbar-brand" href="assets/template/index.html">T<span>ravelrio</span></a></h1>
						</div>
						...
						<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
							<nav class="cl-effect-15" id="cl-effect-15">
								<ul>
									...
									<li><a href="assets/template/about.html" data-hover="About">About</a></li>
									<li><a href="assets/template/gallery.html" data-hover="Gallery">Gallery</a></li>
									<li class="dropdown menu__item">
										...
										<ul class="dropdown-menu">
											<li><a href="assets/template/codes.html">Short Codes</a></li>
											<li><a href="assets/template/icons.html">Web Icons</a></li>
										</ul>
									</li>
									<li><a href="assets/template/contact.html" data-hover="Contact">Contact</a></li>
								</ul>
							</nav>
						</div>
					</nav>
			...
			<div class="modal-dialog">
				...
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4>TRAVELRIO</h4>
						<img src="assets/template/images/bann2.jpg" alt=" " class="img-responsive">
						<h5>Lorem Ipsum</h5>
				...
				<form action="#" method="post">
					<div class="col-md-4 fields">
						...
						<select class="form-control">
										...
										<option>Adisucipto</option>
										<option>SoekarnoHatta</option>
				...
				<ul class="rslides" id="slider3">
					...
					<li>
						<div class="banner-text4">
							<iframe src="assets/template/https://player.vimeo.com/video/92605278"></iframe>
						</div>
					</li>
				</ul>
			</div>
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal">&times;</button>
					<h4>TRAVELRIO</h4>
					<img src="assets/template/images/g2.jpg" alt=" " class="img-responsive">
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal">&times;</button>
					<h4>TRAVELRIO</h4>
					<img src="assets/template/images/g5.jpg" alt=" " class="img-responsive">
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal">&times;</button>
					<h4>TRAVELRIO</h4>
					<img src="assets/template/images/g7.jpg" alt=" " class="img-responsive">
				...
				<div id="owl-demo" class="owl-carousel">
					<div class="item-owl">
						<div class="test-review">
							<div class="img-agile">
								<img src="assets/template/images/c1.jpg" class="img-responsive" alt="" />
							</div>
					...
					<div class="item-owl">
						<div class="test-review">
							<div class="img-agile">
								<img src="assets/template/images/c2.jpg" class="img-responsive" alt="" />
							</div>
							<div class="testi-right-agileits">
					...
					<div class="item-owl">
						<div class="test-review">
							<div class="img-agile">
								<img src="assets/template/images/c3.jpg" class="img-responsive" alt="" />
							</div>
							<div class="testi-right-agileits">
	...
	<div class="w3l_footer_agileinfo">
		<div class="container">
			<div class="col-md-3 mailadd-w3ls">
				<p><span class="fa fa-envelope" aria-hidden="true"></span><a href="assets/template/mailto:info@example.com">info@example.com</a></p>
			</div>
			<div class="col-md-6 botttom-nav-agileits">
				<ul class="nav-w3ls">
					<li><a href="#home" class="scroll">Home</a></li>
					<li><a href="assets/template/about.html">About</a></li>
					<li><a href="assets/template/gallery.html">Gallery</a></li>
					<li><a href="assets/template/contact.html">Contact</a></li>
				</ul>
			</div>
	...
	<div class="copy">
		<div class="container">
			<h2><a href="assets/template/index.html"><span>T</span>ravelrio</a></h2>
			<p>© 2017 TRAVELRIO . All Rights Reserved | Design by <a href="assets/template/http://w3layouts.com/">W3layouts</a> </p>
			<div class="clearfix"> </div>
		</div>
	</div>
	<!--// Copy-right -->
	<!-- js -->
	<script type="text/javascript" src="assets/template/js/jquery-2.2.3.min.js"></script>
	...
	<!--// About-Responsiveslides -->
	<!--Rersponsive tabs-->
	<script src="assets/template/js/easy-responsive-tabs.js"></script>
	<script>
	...
	<!-- //smooth scrolling -->
	<script type="text/javascript" src="assets/template/js/bootstrap-3.1.1.min.js"></script>
